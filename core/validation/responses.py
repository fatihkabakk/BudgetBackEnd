...
class SuccessResponse(Response):
    def __init__(self, message=None):
        super(SuccessResponse, self).__init__(success=True, message=message)


class ErrorResponse(Response):
    def __init__(self, message=None):
        super(ErrorResponse, self).__init__(success=False, message=message)


class DataResponse(Response):
    def __init__(self, success, data=None, message=None):
        super(DataResponse, self).__init__(success=success, message=message)
        self['data'] = data
...
class SuccessDataResponse(DataResponse):
    def __init__(self, data=None, message=None):
        super(SuccessDataResponse, self).__init__(
            success=True, data=data, message=message)


class ErrorDataResponse(DataResponse):
    def __init__(self, data=None, message=None):
        super(ErrorDataResponse, self).__init__(
